app.aniRouting = function($scope) {
    ...
    $scope.Truck = (function () {
         ...
         */
        var Car = function (coords, options) {
            var properties = {
                // Описываем геометрию типа "Точка".
                geometry: {
                    type: "Point",
                    coordinates: coords || [55.75062, 37.62561]
                }
            };
            options = options || {};
            ...
            result.Baloon('je');
            // var result = new ymaps.Placemark(properties["geometry"]["coordinates"],
            //     {
